...
"""
** Summary: **
Build 2D animation of Bay of Bengal and East Arabian Sea SSH
...
xlim = [65,102]
ylim = [4.,26.]
levs = [-2,2] # np.arange(-2,2+0.1,0.1)
ofile = 'FIGURES/BoBEAS_SSH.gif'

f = Dataset(dirname+filename)

## Load in data
var = f.variables[variable][-25:,:,:] # (t, y, x)

# load in time
time_counter = f.variables['time_counter'][-25:] # vector
...
if __name__ == '__main__':
    ...
    for count in range(nt-25,nt):
        ...
        plt.title('Bay of Bengal and East Arabian Sea: Sea Surface Height (m)') #+str(dat))
