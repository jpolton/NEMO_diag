...
"""
** Summary: **
Build 2D animation of Bay of Bengal and East Arabian Sea SST

Load in some existing output INDIAN_1h_20161126_20161230_SSH.nc and plot it and make animation
...
* 2 Junn 2019: Modified for BoBEAS
...
# Fix for BoBEAS
dirname = '/home/n01/n01/jelt/work/BoBEAS/EXP_2016/'
filename = 'INDIAN_1h_20161126_20161230_SSH.nc'
variable = 'tos'
xlim = [65,102]
ylim = [4.,26.]
levs = [20,30] # np.arange(-2,2+0.1,0.1)
ofile = 'FIGURES/BoBEAS_SST.gif'

f = Dataset(dirname+filename)

## Load in data
var = f.variables[variable][::24,:,:] # (t, y, x)

# load in time
time_counter = f.variables['time_counter'][::24] # vector
...
if __name__ == '__main__':
    ...
    for count in range(nt-25,nt):
        ...
        plt.title('Bay of Bengal and East Arabian Sea: Sea Surface Temperature (C)') #+str(dat))
        ax.text(75, 24, str(dat), fontsize=10)
        plt.axis("on")
